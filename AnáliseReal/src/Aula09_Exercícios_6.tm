...
<\body>
  ...
  <\math>
    ...
    \<forall\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:<around*|(|<around*|(|x-\<varepsilon\>,x|)>\<cup\><around*|(|x,x+\<varepsilon\>|)>|)>\<cap\>A\<neq\>\<varnothing\><text|.
    (1)>
  </math>
  ...
  <\math>
    ...
    \<exists\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:<around*|(|<around*|(|x-\<varepsilon\>,x|)>\<cup\><around*|(|x,x+\<varepsilon\>|)>|)>\<cap\><around*|[|a,b|]>=\<varnothing\><text|.>
  </math>
