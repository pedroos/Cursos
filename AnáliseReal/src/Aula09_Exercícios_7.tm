...
<\body>
  ...
  Se <math|x\<nin\><around*|[|a,b|]>>, então existe vizinhança perfurada de
  <math|x> sem intersecção com <math|<around*|[|a,b|]>> (o intervalo é
  fechado).
  ...
  <\math>
    ...
    \<exists\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:<around*|(|<around*|(|x-\<varepsilon\>,x|)>\<cup\><around*|(|x,x+\<varepsilon\>|)>|)>\<cap\><around*|[|a,b|]>=\<varnothing\>\<Rightarrow\>

    \<exists\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:\<neg\><around*|(|\<exists\>a<rprime|'>\<in\><around*|[|a,b|]><mid|\|><around*|(|x-\<varepsilon\>\<less\>a<rprime|'>\<less\>x|)>\<vee\><around*|(|x\<less\>a<rprime|'>\<less\>x+\<varepsilon\>|)>|)>\<Rightarrow\>

    \<exists\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:<around*|[|\<forall\>a<rprime|'>\<in\>\<bbb-R\><mid|\|><around*|(|x-\<varepsilon\>\<less\>a<rprime|'>\<less\>x|)>\<vee\><around*|(|x\<less\>a<rprime|'>\<less\>x+\<varepsilon\>|)>:a<rprime|'>\<nin\><around*|[|a,b|]>|]>
    ou\ 

    <text|<math|\<exists\>\<varepsilon\>\<gtr\>0,\<varepsilon\>\<in\>\<bbb-R\>:<around*|[|\<forall\>a<rprime|'>\<in\>\<bbb-R\>:<around*|(|x-\<varepsilon\>\<less\>a<rprime|'>\<less\>x|)>\<vee\><around*|(|x\<less\>a<rprime|'>\<less\>x+\<varepsilon\>|)>\<Rightarrow\>a<rprime|'>\<nin\><around*|[|a,b|]>|]>>.>
  </math>
  ...
  <\math>
    ...
    <wide|O|\<dot\>><around*|(|x|)>=<around*|(|x-<frac|n|2>,x|)>\<cup\><around*|(|x,x+<frac|n|2>|)>=<around*|(|b+n-<frac|n|2>,x|)>\<cup\><around*|(|x,x+<frac|n|2>|)>=<around*|(|b+<frac|n|2>,x|)>\<cup\><around*|(|x,x+<frac|n|2>|)>

    \<forall\>n\<gtr\>0:b+<frac|n|2>\<gtr\>b\<Rightarrow\>

    <wide|O|\<dot\>><around*|(|x|)>\<cap\><around*|[|a,b|]>=\<varnothing\><text|.>
  </math>
</body>
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|?|1|Aula09_ExercÃ­cios_5.tm>>
    <associate|auto-2|<tuple|?|1|Aula09_ExercÃ­cios_5.tm>>
  </collection>
</references>
